...
public sealed class AllyariaArgumentExceptionTests
{
    [Fact]
    public void Ctor_Default_Should_CreateInstanceWithDefaults()
    {
        // Act
        var sut = new AllyariaArgumentException();
    ...
    {
        // Act
        var sut = new AllyariaArgumentException("msg");
    ...
    {
        // Act
        var sut = new AllyariaArgumentException("msg", "param");
    ...
    {
        // Act
        var sut = new AllyariaArgumentException("msg", "param", 42);
    ...
    public void Ctor_WithMessageAndArgNameAndInner_Should_SetAllProperties()
    {
        ...
        // Act
        var sut = new AllyariaArgumentException("msg", "param", inner);
    ...
    {
        // Act
        var sut = new AllyariaArgumentException("msg", 42);
    ...
    public void Ctor_WithMessageAndArgValueAndInner_Should_SetAllProperties()
    {
        ...
        // Act
        var sut = new AllyariaArgumentException("msg", 42, inner);
    ...
    public void Ctor_WithMessageAndInner_Should_SetMessageAndInner()
    {
        ...
        // Act
        var sut = new AllyariaArgumentException("msg", inner);
    ...
    public void Ctor_WithMessageAndNameAndValueAndInner_Should_SetAllProperties()
    {
        ...
        // Act
        var sut = new AllyariaArgumentException(message, name, value, inner);
    ...
    public void ThrowIfEmptyReadOnlySequence_Should_NotThrow_When_HasElements()
    {
        ...
        // Act
        var act = () => AllyariaArgumentException.ThrowIfEmpty(sequence, "seq");
    ...
    public void ThrowIfEmptyReadOnlySpan_Should_NotThrow_When_HasElements()
    {
        ...
        var act = () =>
        {
            ...
            AllyariaArgumentException.ThrowIfEmpty(span, "ros");
        };
    ...
    public void ThrowIfEmptySpan_Should_NotThrow_When_HasElements()
    {
        ...
        var act = () =>
        {
            ...
            AllyariaArgumentException.ThrowIfEmpty(span, "span");
        };
    ...
    public void ThrowIfNull_Should_NotThrow_When_ValueIsNotNull()
    {
        ...
        // Act
        var act = () => AllyariaArgumentException.ThrowIfNull(value);
    ...
    {
        // Act
        var act = () => AllyariaArgumentException.ThrowIfNull(null, argName?.ToString());
    ...
    {
        // Act
        var act = () => AllyariaArgumentException.ThrowIfNullOrDefault<int>(1, "num");
    ...
    {
        // Act
        var act = () => AllyariaArgumentException.ThrowIfNullOrDefault<int>(0, "num");
    ...
    public void ThrowIfNullOrEmpty_Generic_Should_NotThrow_When_ArrayHasElements()
    {
        ...
        // Act
        var act = () => AllyariaArgumentException.ThrowIfNullOrEmpty(arr, "arr");
    ...
    public void ThrowIfNullOrEmpty_Generic_Should_NotThrow_When_EnumerableEnumeratorHasElements()
    {
        ...
        // Act
        var act = () => AllyariaArgumentException.ThrowIfNullOrEmpty(someEnum, "enm");
    ...
    public void ThrowIfNullOrEmpty_Generic_Should_NotThrow_When_IReadOnlyCollectionHasElements()
    {
        ...
        // Act
        var act = () => AllyariaArgumentException.ThrowIfNullOrEmpty(ro, "ro");
    ...
    public void ThrowIfNullOrEmpty_Generic_Should_Throw_When_EnumerableEnumeratorEmpty()
    {
        ...
        // Act
        var act = () => AllyariaArgumentException.ThrowIfNullOrEmpty(emptyEnum, "enm");
    ...
    public void ThrowIfNullOrEmpty_Generic_Should_Throw_When_IReadOnlyCollectionEmpty()
    {
        ...
        // Act
        var act = () => AllyariaArgumentException.ThrowIfNullOrEmpty(emptyRo, "ro");
    ...
    public void ThrowIfNullOrEmpty_NonGeneric_Should_NotThrow_When_ArrayHasElements()
    {
        ...
        // Act
        var act = () => AllyariaArgumentException.ThrowIfNullOrEmpty(value, "items");
    ...
    {
        // Act
        var act = () => AllyariaArgumentException.ThrowIfNullOrEmpty((IEnumerable?)null, "items");
    ...
    public void ThrowIfNullOrEmptyEnumerable_NonGeneric_Should_NotThrow_When_HasElements()
    {
        ...
        // Act
        var act = () => AllyariaArgumentException.ThrowIfNullOrEmpty(list, "list");
    ...
    {
        // Act
        var act = () => AllyariaArgumentException.ThrowIfNullOrEmpty((IEnumerable<int>?)null, "list");
    ...
    public void ThrowIfNullOrEmptyMemory_Should_NotThrow_When_HasElements()
    {
        ...
        // Act
        var act = () => AllyariaArgumentException.ThrowIfNullOrEmpty(memory, "mem");
    ...
    public void ThrowIfNullOrEmptyReadOnlyMemory_Should_NotThrow_When_HasElements()
    {
        ...
        // Act
        var act = () => AllyariaArgumentException.ThrowIfNullOrEmpty(memory, "romem");
    ...
    {
        // Act
        var act = () => AllyariaArgumentException.ThrowIfNullOrEmpty("ok", "s");
    ...
    {
        // Act
        var act = () => AllyariaArgumentException.ThrowIfNullOrEmpty(value, "s");
    ...
    {
        // Act
        var act = () => AllyariaArgumentException.ThrowIfNullOrWhiteSpace("a", "s");
    ...
    {
        // Act
        var act = () => AllyariaArgumentException.ThrowIfNullOrWhiteSpace(value, "s");
    ...
    {
        // Act
        var act = () => AllyariaArgumentException.ThrowIfOutOfRange<float>(1.5f, 1f, 2f, "f");
    ...
    {
        // Act
        var act = () => AllyariaArgumentException.ThrowIfOutOfRange<int>(5, null, null, "n");
    ...
    {
        // Arrange + Act
        var act = () => AllyariaArgumentException.ThrowIfOutOfRange<int>(7, 10, 5, "n");
    ...
    {
        // Act
        var act = () => AllyariaArgumentException.ThrowIfOutOfRange<int>(7, 5, 10, "n");
    ...
    {
        // Act
        var act = () => AllyariaArgumentException.ThrowIfOutOfRange<double>(value, 0d, 100d, "d");
    ...
    {
        // Act
        var act = () => AllyariaArgumentException.ThrowIfOutOfRange<int>(20, 5, 10, "n");
    ...
    {
        // Act
        var act = () => AllyariaArgumentException.ThrowIfOutOfRange<int>(1, 5, 10, "n");
