...
public sealed class AryImageValueTests
{
    [Theory]
    ...
    public void Ctor_Should_AllowUrl_When_AbsoluteUrlWithAllowedScheme(string input)
    {
        ...
        // Act
        var sut = new AryImageValue(input);
        string result = sut;
    ...
    {
        // Arrange
        AryColorValue background = "#000000";
        var input = "photo.jpg";

        // Act
        var sut = new AryImageValue(input, background);
        string result = sut;
    ...
    {
        // Arrange
        AryColorValue background = "#ffffff";
        var input = "photo.jpg";
        ...
        string scheme)
    {
        ...
        // Act
        var act = () => new AryImageValue(input);
    ...
    {
        // Arrange
        AryImageValue sut = "assets/a.png";
    ...
    public void Parse_Should_ReturnEquivalentResultToConstructor_When_Valid()
    {
        ...
        // Act
        var sut = AryImageValue.Parse(input);
        string result = sut;
    ...
    public void TryParse_Should_ReturnFalseAndNull_When_Invalid()
    {
        ...
        // Act
        var ok = AryImageValue.TryParse(input, out var parsed);
