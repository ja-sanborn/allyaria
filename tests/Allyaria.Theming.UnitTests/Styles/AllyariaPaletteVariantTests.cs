...
public sealed class AllyariaPaletteVariantTests
{
    ...
    {
        // Arrange
        var baseLight = new AllyariaPalette(StyleDefaults.BackgroundColorLight, StyleDefaults.BackgroundColorDark);
        var baseDark = new AllyariaPalette(StyleDefaults.BackgroundColorDark, StyleDefaults.ForegroundColorDark);

        var baseHc = new AllyariaPalette(
            StyleDefaults.BackgroundColorHighContrast, StyleDefaults.ForegroundColorHighContrast
        );

        var baseline = new AllyariaPaletteVariant(baseLight, baseDark, baseHc);
    ...
    {
        // Arrange
        var original = new AllyariaPaletteVariant();

        var newLight = new AllyariaPalette(
            StyleDefaults.BackgroundColorHighContrast, StyleDefaults.ForegroundColorHighContrast
        );

        var newDark = new AllyariaPalette(StyleDefaults.BackgroundColorLight, StyleDefaults.ForegroundColorDark);
        var newHc = new AllyariaPalette(StyleDefaults.BackgroundColorDark, StyleDefaults.BackgroundColorLight);
    ...
    {
        // Arrange & Act
        var sut = new AllyariaPaletteVariant(null);

        // Assert
        sut.LightPalette.Should().Be(
            new AllyariaPalette(StyleDefaults.BackgroundColorLight, StyleDefaults.BackgroundColorDark)
        );

        sut.DarkPalette.Should().Be(
            new AllyariaPalette(StyleDefaults.BackgroundColorDark, StyleDefaults.ForegroundColorDark)
        );

        sut.HighContrastPalette.Should().Be(
            new AllyariaPalette(StyleDefaults.BackgroundColorHighContrast, StyleDefaults.ForegroundColorHighContrast)
        );
    ...
    {
        // Arrange
        var sut = new AllyariaPaletteVariant();
