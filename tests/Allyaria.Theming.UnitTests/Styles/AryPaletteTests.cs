...
public sealed class AryPaletteTests
{
    ...
    public void Cascade_Should_OverrideOnlyProvidedMembers_And_RecontrastForeground_When_BackgroundChanges()
    {
        ...
        var sut = new AryPalette(initialBackground, initialForeground, initialBorder);
    ...
    {
        // Arrange
        var sut = new AryPalette(Colors.Black, Colors.White, Colors.Red500);
    ...
    public void Ctor_Should_AdjustForeground_ToMeetContrast_When_Insufficient()
    {
        ...
        // Act
        var sut = new AryPalette(background, lowContrastForeground, Colors.White);
    ...
    public void Ctor_Should_DefaultBorderToBackground_When_BorderNotProvided()
    {
        ...
        // Act
        var sut = new AryPalette(background, foreground);
    ...
    {
        // Arrange
        var background = new AryColorValue(bgHex);
        var requestedForeground = new AryColorValue(fgHex);
        ...
        // Act
        var sut = new AryPalette(background, requestedForeground);
    ...
    public void ToCss_Should_ContainDeclarations_For_Foreground_Background_And_Border()
    {
        ...
        var sut = new AryPalette(bg, fg, bd);
