...
public sealed class AryPaletteStateTests
{
    ...
    public void Ctor_Should_Derive_All_State_Palettes_From_Default_When_BaselineProvided()
    {
        ...
        // Act
        var sut = new AryPaletteState(baseline);
    ...
    {
        // Arrange
        var basePalette = new AryPalette(); // deterministic defaults
        var sut = new AryPaletteState(basePalette);
