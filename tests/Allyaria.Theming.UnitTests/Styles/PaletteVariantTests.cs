...
public sealed class PaletteVariantTests
{
    [Fact]
    ...
    public void Cascade_Should_Return_New_Instance_With_All_Overrides_When_All_Specified()
    {
        ...
        // Assert
        sut.Should().NotBe(original); // record struct theme should differ due to different contents
        ...
        ComponentState state)
    {
        ...
        var sut = new PaletteVariant(light, dark, high);
