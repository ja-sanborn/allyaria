...
public sealed class AllyariaTypographyComponentTests
{
    [Fact]
    public void Cascade_Should_ReturnNewInstanceWithOverride_When_SurfaceTypographyProvided()
    {
        ...
        var overrideTypography = new AllyariaTypography(); // distinct instance/value
        var sut = new AllyariaTypographyComponent(original);
    ...
    public void Ctor_Should_UseDefaultTypography_When_SurfaceTypographyIsNull()
    {
        ...
        // Act
        var sut = new AllyariaTypographyComponent(null);

        // Assert
        sut.Surface.Should().BeEquivalentTo(new AllyariaTypography());
    }
    ...
    {
        // Arrange
        var provided = new AllyariaTypography();

        // Act
        var sut = new AllyariaTypographyComponent(provided);
    ...
    {
        // Arrange & Act
        var sut = new AllyariaTypographyComponent();
    ...
    {
        // Arrange
        var expected = new AllyariaTypography();
        var sut = new AllyariaTypographyComponent(expected);
