...
public sealed class AllyariaPaletteElevationTests
{
    [Fact]
    public void Ctor_Should_CreateDefaultPalette_When_PaletteIsNull()
    {
        // Arrange & Act
        var sut = new AllyariaPaletteElevation(null);
    ...
    public void Ctor_Should_SetProvidedPalette_When_PaletteIsNotNull()
    {
        ...
        // Act
        var sut = new AllyariaPaletteElevation(provided);
    ...
    {
        // Arrange
        var sut = new AllyariaPaletteElevation(new AllyariaPalette());
        var state = ComponentState.Default;
