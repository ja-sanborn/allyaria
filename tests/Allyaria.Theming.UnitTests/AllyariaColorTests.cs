...
public class AllyariaColorTests
{
    ...
    [Fact]
    public void CompareTo_Uses_Ordinal_On_HexRgba()
    {
        var a = new AllyariaColor("#00FF00FF");
        var b = new AllyariaColor("#00FF00FE");

        a.CompareTo(b)
            .Should()
            .BeGreaterThan(0); // "...FF" > "...FE"
    }
    ...
    [Fact]
    public void ToCss_Uses_Default_Property_Or_Custom_Name()
    {
        var c = new AllyariaColor("#FF8800C0");
    ...
    [Fact]
    public void ToString_Returns_HexRgba_Uppercase()
    {
        var c = AllyariaColor.FromRgba(0, 255, 16, 0.5);

        c.ToString()
            .Should()
            .Be(c.HexRgba); // ToString == #RRGGBBAA
