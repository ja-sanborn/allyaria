...
public static class AryGuard
{
    ...
    public static void Check(bool condition, string argName, string message)
        => CheckError(ex: AryChecks.Check(condition: condition, argName: argName, message: message));
