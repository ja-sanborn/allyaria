...
public sealed class AryResult
{
    ...
    /// <param name="errorCode">An optional error code string providing machine-readable context.</param>
    /// <param name="errorMessage">An optional human-readable error message.</param>
    private AryResult(bool isSuccess, Exception? error = null, string? errorCode = null, string? errorMessage = null)
    {
        IsSuccess = isSuccess;
        Error = error;
    ...
    /// <summary>Gets the error code that identifies the type or category of failure.</summary>
    /// <value>A machine-readable error code, or <see langword="null" /> if the result represents success.</value>
    public string? ErrorCode { get; }

    /// <summary>Gets the human-readable error message that describes the failure.</summary>
    /// <value>A descriptive error message, or <see langword="null" /> if the result represents success.</value>
