...
///     </item>
/// </list>
/// Any invalid input throws <see cref="AllyariaArgumentException" />.
/// </remarks>
public sealed class AllyariaNumberValue : ValueBase
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AllyariaNumberValue" /> class by parsing and normalizing the provided
    ...
    private static string Normalize(string raw, out double number, out LengthUnits? unit)
    {
        ...
        if (!string.IsNullOrEmpty(unitText))
        {
            ...
            {
                throw new AllyariaArgumentException($"Unsupported unit token '{unitText}'.", nameof(raw), raw);
            }
    ...
    /// <summary>Parses the specified string into an <see cref="AllyariaNumberValue" />.</summary>
    /// <param name="value">The input string to parse.</param>
    /// <returns>A new <see cref="AllyariaNumberValue" /> instance.</returns>
    /// <exception cref="AllyariaArgumentException">Thrown when <paramref name="value" /> cannot be parsed/validated.</exception>
    ...
    /// <summary>Attempts to parse the specified string into an <see cref="AllyariaNumberValue" />.</summary>
    /// <param name="value">The input string to parse.</param>
    /// <param name="result">
    /// When this method returns, contains the parsed <see cref="AllyariaNumberValue" /> if parsing succeeded; otherwise
    /// <c>null</c>.
    /// </param>
    ...
    /// <summary>Defines an implicit conversion from <see cref="string" /> to <see cref="AllyariaNumberValue" />.</summary>
    /// <param name="value">The input string to convert.</param>
    /// <returns>A new <see cref="AllyariaNumberValue" /> instance.</returns>
    /// <exception cref="AllyariaArgumentException">Thrown when <paramref name="value" /> is invalid.</exception>
    public static implicit operator AllyariaNumberValue(string value) => new(value);

    /// <summary>
    /// Defines an implicit conversion from <see cref="AllyariaNumberValue" /> to <see cref="string" />, returning the
    /// canonical <see cref="ValueBase.Value" /> representation (e.g., <c>"12px"</c>, <c>"100%"</c>, <c>"-3.5"</c>).
    /// </summary>
