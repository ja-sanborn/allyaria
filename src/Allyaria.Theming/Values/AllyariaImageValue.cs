...
public sealed class AllyariaImageValue : ValueBase
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AllyariaImageValue" /> class from the provided raw value, normalizing it
    /// to a canonical CSS <c>url("…")</c> token. If a <paramref name="backgroundColor" /> is supplied, a theme-appropriate
    /// overlay is prepended via a <c>linear-gradient(...)</c> per theming rules.
    /// </summary>
    ...
    /// scheme.
    /// </exception>
    public AllyariaImageValue(string value, AllyariaColorValue? backgroundColor = null)
    ...
    /// <exception cref="AllyariaArgumentException">
    /// Thrown when <paramref name="value" /> is invalid or uses a
    /// disallowed/dangerous scheme.
    /// </exception>
    private static string Normalize(string value, AllyariaColorValue? backgroundColor = null)
    {
    ...
    /// <exception cref="AllyariaArgumentException">
    /// Thrown when <paramref name="value" /> is invalid; see <see cref="Normalize(string, AllyariaColorValue?)" /> for the
    /// validation rules.
    /// </exception>
