...
public interface IThemeWatcher : IAsyncDisposable
{
    ...
    /// the same effective theme by coalescing changes.
    /// </summary>
    /// <remarks>
    /// The event sender should be the instance of <see cref="IThemeWatcher" /> raising the event. No event arguments are
    /// provided; consumers should read the new theme from <see cref="Current" />.
    /// </remarks>
    ...
    /// <see cref="Current" /> with the returned theme.
    /// </returns>
