...
public static class StyleDefaults
{
    ...
    public static readonly AryColorValue BackgroundColorDark = Colors.Grey900;

    /// <summary>Default background color for high-contrast theme.</summary>
    public static readonly AryColorValue BackgroundColorHighContrast = Colors.White;

    /// <summary>Default background color for light theme.</summary>
    public static readonly AryColorValue BackgroundColorLight = Colors.Grey50;
    ...
    public static readonly AryColorValue ForegroundColorDark = Colors.Grey50;

    /// <summary>Default foreground color for high-contrast theme.</summary>
    public static readonly AryColorValue ForegroundColorHighContrast = Colors.Black;

    /// <summary>Default foreground color for light theme.</summary>
    public static readonly AryColorValue ForegroundColorLight = Colors.Grey900;
