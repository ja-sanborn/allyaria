...
public static class StyleDefaults
{
    ...
    public static readonly AryStringValue FontFamily = new("system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica, Arial, sans-serif");
    ...
    public static readonly AryPalette PaletteDark = new(
    ...
    public static readonly AryPalette PaletteLight = new(
