...
public static class AlignPositioning
{
    ...
    public static readonly ThemeString FirstBaseline = new("first baseline");
    public static readonly ThemeString FlexEnd = new("flex-end");
    public static readonly ThemeString FlexStart = new("flex-start");
    public static readonly ThemeString LastBaseline = new("last baseline");
