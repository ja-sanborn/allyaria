...
public static class CssFontWeight
{
    ...
    public static readonly StyleValueString Bold = new("bold");

    /// <summary>Represents a font weight of 100.</summary>
    public static readonly StyleValueString Bold1 = new("100");

    /// <summary>Represents a font weight of 200.</summary>
    public static readonly StyleValueString Bold2 = new("200");

    /// <summary>Represents a font weight of 300.</summary>
    public static readonly StyleValueString Bold3 = new("300");

    /// <summary>Represents a font weight of 400.</summary>
    public static readonly StyleValueString Bold4 = new("400");

    /// <summary>Represents a font weight of 500.</summary>
    public static readonly StyleValueString Bold5 = new("500");

    /// <summary>Represents a font weight of 600.</summary>
    public static readonly StyleValueString Bold6 = new("600");

    /// <summary>Represents a font weight of 700.</summary>
    public static readonly StyleValueString Bold7 = new("700");

    /// <summary>Represents a font weight of 800.</summary>
    public static readonly StyleValueString Bold8 = new("800");

    /// <summary>Represents a font weight of 900.</summary>
    public static readonly StyleValueString Bold9 = new("900");

    /// <summary>Represents a bolder font weight relative to the parent element.</summary>
    public static readonly StyleValueString Bolder = new("bolder");

    /// <summary>Represents a lighter font weight relative to the parent element.</summary>
    public static readonly StyleValueString Lighter = new("lighter");
