...
/// immutable (readonly record struct) and safe for theme semantics.
/// </remarks>
public readonly record struct Spacing
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Spacing" /> struct using all default margin and padding values from
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Spacing" /> struct, applying provided values or falling back to
    /// <see cref="StyleDefaults.Margin" /> and <see cref="StyleDefaults.Padding" /> when a theme is not supplied.
    /// </summary>
    ...
    public Spacing(ThemeNumber? marginTop = null,
        ThemeNumber? marginEnd = null,
        ThemeNumber? marginBottom = null,
        ThemeNumber? marginStart = null,
        ThemeNumber? paddingTop = null,
        ThemeNumber? paddingEnd = null,
        ThemeNumber? paddingBottom = null,
        ThemeNumber? paddingStart = null)
    {
    ...
    /// <returns>A new <see cref="Spacing" /> with supplied values applied and unspecified values preserved.</returns>
    public Spacing Cascade(ThemeNumber? marginTop = null,
        ThemeNumber? marginEnd = null,
        ThemeNumber? marginBottom = null,
        ThemeNumber? marginStart = null,
        ThemeNumber? paddingTop = null,
    ...
    /// <summary>
    /// Creates an <see cref="Spacing" /> where all margins use the same theme and all paddings use the same theme.
    /// </summary>
    /// <param name="margin">The margin theme to apply to all sides.</param>
    /// <param name="padding">The padding theme to apply to all sides.</param>
    /// <returns>A new <see cref="Spacing" /> instance with uniform margins and paddings.</returns>
    public static Spacing FromSingle(ThemeNumber margin, ThemeNumber padding)
        => new(margin, margin, margin, margin, padding, padding, padding, padding);

    /// <summary>Creates an <see cref="Spacing" /> with symmetric horizontal and vertical margins and paddings.</summary>
    /// <param name="marginHorizontal">The margin theme for left and right sides.</param>
    /// <param name="marginVertical">The margin theme for top and bottom sides.</param>
    /// <param name="paddingHorizontal">The padding theme for left and right sides.</param>
    /// <param name="paddingVertical">The padding theme for top and bottom sides.</param>
    /// <returns>A new <see cref="Spacing" /> instance with symmetric spacing.</returns>
    public static Spacing FromSymmetric(ThemeNumber marginHorizontal,
        ThemeNumber marginVertical,
        ThemeNumber paddingHorizontal,
        ThemeNumber paddingVertical)
        => new(
