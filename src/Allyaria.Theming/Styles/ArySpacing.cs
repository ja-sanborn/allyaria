...
public readonly record struct ArySpacing
{
    ...
    public ArySpacing(AryNumberValue? marginTop = null,
        AryNumberValue? marginRight = null,
        AryNumberValue? marginBottom = null,
        AryNumberValue? marginLeft = null,
        AryNumberValue? paddingTop = null,
        AryNumberValue? paddingRight = null,
        AryNumberValue? paddingBottom = null,
        AryNumberValue? paddingLeft = null)
    {
    ...
    public AryNumberValue MarginLeft { get; init; }

    /// <summary>Gets or initializes the margin on the right side.</summary>
    public AryNumberValue MarginRight { get; init; }
    ...
    public AryNumberValue PaddingLeft { get; init; }

    /// <summary>Gets or initializes the padding on the right side.</summary>
    public AryNumberValue PaddingRight { get; init; }
