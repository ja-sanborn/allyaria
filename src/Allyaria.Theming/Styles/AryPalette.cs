...
/// <see cref="ColorHelper.EnsureMinimumContrast(AryColorValue, AryColorValue, double)" />.
/// </remarks>
public readonly record struct AryPalette
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AryPalette" /> struct using the default light theme colors.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AryPalette" /> struct with optional custom colors. If any value is
    ...
    /// <summary>
    /// Returns a new <see cref="AryPalette" /> instance with optional color overrides applied. Any parameter that is
    ...
    /// <returns>A new <see cref="AryPalette" /> instance with overrides applied and minimum contrast enforced.</returns>
    /// <remarks>
