...
{
    public AllyariaPaletteElevation()
        : this(null) { }

    public AllyariaPaletteElevation(AllyariaColorValue? backgroundColor = null,
    ...
    public AllyariaPaletteElevation Cascade(AllyariaColorValue? backgroundColor = null,
        AllyariaColorValue? foregroundColor = null,
        AllyariaColorValue? borderColor = null)
    {
        var next = this with
