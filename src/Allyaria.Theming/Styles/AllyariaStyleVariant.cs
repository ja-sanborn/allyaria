...
/// <summary>
/// Represents a composite Allyaria style configuration containing paletteVariant, typography, spacing, and border
/// settings.
/// </summary>
public readonly record struct AllyariaStyleVariant
{
    ...
    /// </summary>
    /// <param name="palette">The color paletteVariant component, or <c>null</c> to use defaults.</param>
    ...
    public AllyariaStyleVariant(AllyariaPaletteVariant? palette = null,
        AllyariaTypography? typography = null,
        AllyariaSpacing? spacing = null,
        AllyariaBorders? border = null)
    {
        PaletteVariant = palette ?? new AllyariaPaletteVariant();
    ...
    /// <summary>Gets the color paletteVariant configuration for this style.</summary>
    public AllyariaPaletteVariant PaletteVariant { get; init; }
    ...
    /// <param name="palette">An optional replacement paletteVariant.</param>
    ...
    public AllyariaStyleVariant Cascade(AllyariaPaletteVariant? palette = null,
        AllyariaTypography? typography = null,
        AllyariaSpacing? spacing = null,
        AllyariaBorders? border = null)
        => this with
        {
            PaletteVariant = palette ?? PaletteVariant,
    ...
    public string ToCss(string? varPrefix = "")
        => string.Concat(
            PaletteVariant.ToCss(varPrefix),
