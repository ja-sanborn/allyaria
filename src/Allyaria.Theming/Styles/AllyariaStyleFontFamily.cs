...
public readonly record struct AllyariaStyleFontFamily
{
    ...
    public AllyariaStyleFontFamily(string value)
    {
        ...
        _style = new AllyariaFontFamilyValue(value);
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="AllyariaStyleFontFamily" /> struct from a strongly typed
    /// <see cref="AllyariaFontFamilyValue" />.
    /// </summary>
    /// <param name="familyValue">The CSS font-familyValue instance.</param>
    public AllyariaStyleFontFamily(AllyariaFontFamilyValue familyValue) => _style = familyValue;

    /// <summary>
    /// Gets the underlying style value. Returns a default <see cref="AllyariaFontFamilyValue" /> with an empty string if unset.
    /// </summary>
    public StyleValueBase Style => _style ?? new AllyariaFontFamilyValue(string.Empty);
    ...
    /// <summary>
    /// Implicitly converts a <see cref="AllyariaFontFamilyValue" /> into an <see cref="AllyariaStyleFontFamily" />.
    /// </summary>
    /// <param name="familyValue">The <see cref="AllyariaFontFamilyValue" /> instance.</param>
    public static implicit operator AllyariaStyleFontFamily(AllyariaFontFamilyValue familyValue) => new(familyValue);
    ...
    /// <summary>
    /// Implicitly converts an <see cref="AllyariaStyleFontFamily" /> into a <see cref="AllyariaFontFamilyValue" />.
    /// </summary>
    /// <param name="family">The <see cref="AllyariaStyleFontFamily" /> instance.</param>
    /// <returns>The <see cref="AllyariaFontFamilyValue" /> extracted from the underlying style.</returns>
    /// <exception cref="InvalidCastException">Thrown if the underlying style is not a <see cref="AllyariaFontFamilyValue" />.</exception>
