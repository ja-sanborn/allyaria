...
/// <seealso cref="TypographyArea" />
public readonly record struct Theme
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Theme" /> struct using default values for all subcomponents.
    /// </summary>
    public Theme()
        : this(null) { }

    /// <summary>
    /// Initializes a new instance of the <see cref="Theme" /> struct with optional subcomponents. Any parameter left as
    ...
    /// <returns>A new <see cref="Theme" /> with supplied overrides applied.</returns>
    /// <example>
    ///     <code>
    /// var theme = new Theme();
    /// var updated = theme.Cascade(paletteDark: new Palette(backgroundThemeColor: "#111", foregroundColor: "#eee"));
    /// </code>
    /// </example>
    public Theme Cascade(Borders? borders = null,
        Spacing? spacing = null,
        Palette? paletteLight = null,
        Palette? paletteDark = null,
        Palette? paletteHighContrast = null,
    ...
    /// <param name="state">The component state to use; defaults to <see cref="ComponentState.Default" />.</param>
    /// <returns>
    /// An <see cref="Style" /> instance constructed from the theme’s palette, typography, spacing, and borders appropriate to
    /// the provided inputs.
    /// </returns>
    public Style ToStyle(ThemeType themeType,
        ComponentType componentType,
        ComponentElevation elevation = ComponentElevation.Mid,
        ComponentState state = ComponentState.Default)
        => new(
