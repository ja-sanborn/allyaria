...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="HexByte" /> struct with a value of 0 (string form <c>"00"</c>).
    /// </summary>
    public HexByte()
        : this(0) { }

    /// <summary>Initializes a new instance of the <see cref="HexByte" /> struct using a byte value.</summary>
    /// <param name="value">The byte value to represent as hexadecimal.</param>
    ...
    /// <param name="value">
    /// The hexadecimal string representing the byte value; accepts 1–2 hex characters (e.g., <c>"F"</c>, <c>"0A"</c>,
    ...
    /// <summary>Gets the byte representation of the hexadecimal value.</summary>
    public byte Value { get; }

    /// <summary>
    /// Clamps a normalized alpha value between 0.0 and 1.0 and converts it to a <see cref="HexByte" /> representation.
    /// </summary>
    /// <param name="value">The alpha value to clamp (expected 0.0–1.0; values outside are clamped).</param>
    /// <returns>A <see cref="HexByte" /> corresponding to the clamped value.</returns>
    ...
    /// <summary>Creates a <see cref="HexByte" /> from a normalized value in the range [0, 1].</summary>
    /// <param name="value">A normalized channel value between 0.0 and 1.0 inclusive.</param>
    /// <returns>A <see cref="HexByte" /> whose numeric value corresponds to <paramref name="value" />·255.</returns>
    /// <exception cref="AryArgumentException">
    ...
    /// <returns>A new <see cref="HexByte" /> representing the parsed value.</returns>
    /// <exception cref="AryArgumentException">
    ...
    /// </summary>
    /// <param name="end">The end byte value (0–255).</param>
    ...
    /// <param name="end">The end byte value (0–255).</param>
    /// <param name="factor">The interpolation factor; values are clamped to [0, 1]. Non-finite values are treated as 0.</param>
    /// <returns>A new <see cref="HexByte" /> representing the interpolated channel value.</returns>
    public HexByte ToLerpHexByte(byte end, double factor) => new(ToLerpByte(end, factor));

    /// <summary>
    /// Computes a gamma-correct (linear-light) interpolation from this channel value to <paramref name="end" />, returning the
    /// resulting sRGB 8-bit value.
    /// </summary>
    /// <param name="end">The end byte value (0–255).</param>
    /// <param name="factor">The interpolation factor; values are clamped to [0, 1]. Non-finite values are treated as 0.</param>
    /// <returns>The interpolated sRGB channel byte.</returns>
    ...
    /// </summary>
    /// <param name="end">The target channel value.</param>
    /// <param name="factor">
    ...
    /// <summary>Converts this channel value to a normalized value in the range [0, 1] via <c>Value / 255.0</c>.</summary>
    /// <returns>The normalized channel value.</returns>
    public double ToNormalized() => Value / 255.0;

    /// <summary>
    /// Converts this sRGB channel value to linear-light in the range [0, 1] using the sRGB electro-optical transfer function.
    /// </summary>
    ...
    /// <summary>Returns the string representation of the HexByte value.</summary>
    ...
    /// <param name="result">
    /// When this method returns, contains the parsed <see cref="HexByte" /> if parsing succeeded; otherwise the default value.
    /// </param>
    ...
    /// <summary>Returns a value that indicates whether the values of two <see cref="HexByte" /> objects are equal.</summary>
    /// <param name="left">The first value to compare.</param>
    /// <param name="right">The second value to compare.</param>
    /// <returns><see langword="true" /> if both have the same value; otherwise, <see langword="false" />.</returns>
    public static bool operator ==(HexByte left, HexByte right) => left.Equals(right);

    /// <summary>Determines whether one <see cref="HexByte" /> value is greater than another.</summary>
    ...
    /// <summary>Determines whether one <see cref="HexByte" /> value is greater than or equal to another.</summary>
    /// <param name="left">The left operand.</param>
    /// <param name="right">The right operand.</param>
    /// <returns>
    ...
    /// <returns>A <see cref="HexByte" /> representing the parsed value.</returns>
    ...
    /// <summary>Converts a <see cref="HexByte" /> instance to its byte value.</summary>
    /// <param name="value">The value to convert.</param>
    /// <returns>The underlying byte value.</returns>
    public static implicit operator byte(HexByte value) => value.Value;

    /// <summary>Returns a value that indicates whether two <see cref="HexByte" /> objects have different values.</summary>
    /// <param name="left">The first value to compare.</param>
    /// <param name="right">The second value to compare.</param>
    /// <returns>
    ...
    /// <summary>Determines whether one <see cref="HexByte" /> value is less than another.</summary>
    /// <param name="left">The left operand.</param>
    /// <param name="right">The right operand.</param>
    /// <returns>
    ...
    /// <summary>Determines whether one <see cref="HexByte" /> value is less than or equal to another.</summary>
    /// <param name="left">The left operand.</param>
    /// <param name="right">The right operand.</param>
    /// <returns>
